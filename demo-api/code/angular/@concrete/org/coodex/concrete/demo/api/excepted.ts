...
export class MessageTriggerService extends AbstractConcreteService {
    ...
    public trigger(msg: string): Observable<void> {
        return this.http.request('POST', MessageTriggerService.$$getServiceRoot() + `/OrgCoodexConcreteDemoApiExceptedMessageTriggerService/trigger`, MessageTriggerService.defaultRequestOptions({ msg: msg }))
...
export class DemoSignatureService extends AbstractConcreteService {
    ...
    public doSomeThing(a: number, kkk: string, pojo: ExamplePojo): Observable<void> {
        return this.http.request('POST', DemoSignatureService.$$getServiceRoot() + `/OrgCoodexConcreteDemoApiExceptedDemoSignatureService/doSomeThing`, DemoSignatureService.defaultRequestOptions({ a: a, kkk: kkk, pojo: pojo }))
...
export class DemoLoginService extends AbstractConcreteService {
    ...
    public login(id: string): Observable<void> {
        return this.http.request('POST', DemoLoginService.$$getServiceRoot() + `/OrgCoodexConcreteDemoApiExceptedDemoLoginService/login`, DemoLoginService.defaultRequestOptions({ id: id }))
