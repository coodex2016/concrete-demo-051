...
import { AddService, AddWithIn10Service, CarService, ErrorCodeService, SubjoinExampleService, TimeLimitedService, TokenDemoService } from './org/coodex/concrete/demo/api';
...
@NgModule({
    ...
    providers: [{
        ...
        multi: true,
    }, Broadcast, AddService, AddWithIn10Service, CarService, DemoLoginService, DemoSignatureService, ErrorCodeService, LibraryA, LibraryB, LimitingService, MessageTriggerService, SubjoinExampleService, TimeLimitedService, TokenDemoService],
})
